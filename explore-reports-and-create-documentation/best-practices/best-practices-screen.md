...
* [Creating new best practice reports](best-practices-screen.md#internal/explore-reports-and-create-documentation/best-practices/best-practices-reports).
...
* Personalize the Best Practices dashboard by hiding reports you do not wish to track or adjust some of the built-in values using the [Customize Best Practices](best-practices-screen.md#internal/explore-reports-and-create-documentation/best-practices/best-practices-reports) button.
* [Creating new alerts](best-practices-screen.md#internal/explore-reports-and-create-documentation/subscriptions-and-alerts/create-new-alert) for the configuration settings you wish to track. If you choose to create an alert for a specific best practice report, you will receive this report each time SPDocKit detects either an error or a warning.
