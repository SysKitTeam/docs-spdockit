...
1. To install SPCAF extension you can use either online of offline installation. For detailed instructions click [here](../how-to/reports/install-spdockit-extensions.md).
