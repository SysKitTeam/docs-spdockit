...
* __SPDocKit Service is now available as part of SPDocKit Online__. Use a domain account or a local system account to configure automatic snapshots of your tenant and send report subscriptions or alerts.
