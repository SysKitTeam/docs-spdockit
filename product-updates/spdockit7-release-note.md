...
* SPDocKit installation now includes the **LocalDB** option. This option will automatically appear during the installation when SPDocKit is used on a workstation and will come in handy when documenting SPO.
