...
You can find more details about Query creation [here](../query-and-change-sharepoint-settings/create-spdockit-query.md).
...
For a detailed description of the Rule creation please read [this article](../query-and-change-sharepoint-settings/create-governance-policy-rule.md).
