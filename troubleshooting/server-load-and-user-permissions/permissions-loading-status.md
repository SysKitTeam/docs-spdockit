...
Make sure that the user account running SPDocKit has the proper [permission privileges](permissions-loading-status.md#internal/requirements/user-permissions-requirements) for the SharePoint farm for which you are trying to load the permissions.
