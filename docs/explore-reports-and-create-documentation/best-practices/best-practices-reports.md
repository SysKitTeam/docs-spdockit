...
<DownloadButton 
  href="/spdockit/download/number-of-content-databases-per-web-application.zip"
  filename="Number-of-content-databases-per-Web-Application.zip"
  description="Custom best practices report example for content databases per web application"
/>
