...
Please note that there is an option to “Mark Configuration as Good”. Marking a snapshot this way will exclude it from the data retention. For more information on this go [here](#internal/create-sharepoint-farm-snapshots/snapshots-screen).
