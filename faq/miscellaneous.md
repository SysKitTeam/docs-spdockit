...
Here is what you need to do: 1. Obtain the original MSI file you used to install the product \(product version e.g. 1.0.3 is listed in **Control Panel &gt; Programs**, but you can [contact us](https://www.spdockit.com/support/contact-us/) to obtain the original installation\). 2. Right-click the MSI file and choose **Repair** to repair the application. 3. Use **Control Panel &gt; Programs** to uninstall the application. 4. Once uninstalled, you can **install** the latest version as planned.
