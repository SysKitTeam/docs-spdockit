...
* If the firewall is enabled, verify that the required ports are also enabled, as stated [here](../faq/faq/miscellaneous/README.md#network-ports-required-for-gathering-the-data.md) in the section entitled “Network ports required for gathering the data”.
