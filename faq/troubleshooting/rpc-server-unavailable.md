...
* If the firewall is enabled, verify that the required ports are also enabled, as stated [here](../miscellaneous.md) in the section entitled “Network ports required for gathering the data”.
