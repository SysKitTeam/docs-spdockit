...
The user running the application needs to have proper privileges to access the information about Site Collections stored in the content databases. [See this article](../faq/requirements/sharepoint-on-premises-user-permissions-requirements.md) for more details on configuring privileges.
