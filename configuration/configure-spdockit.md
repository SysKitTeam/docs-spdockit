...
**Please note!** To configure your SPDocKit settings more thoroughly, navigate to the **File** tab, click on the **Configuration** in the left navigation bar and press [Options](configure-spdockit.md#internal/configure-and-extend-spdockit/backstage-screen) button.
...
2. Follow the [Installation Guide](configure-spdockit.md#internal/installation/installation-guide/) to install it on your workstation. Once you have successfully installed the tool, the Configuration Wizard will open.
