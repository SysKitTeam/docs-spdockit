...
The Best Practice section contains built-in reports that help SharePoint administrators check if their SharePoint farm has been configured according to the official best practices and if the current state of the SharePoint farm comforms with published software boundaries and limits. It also allows administrators to [create their own best practice reports].
...
* Produce a __Best Practices Documentation__ file containing all best practices reports and dashboard.
...
* [Creating new alerts](#internal/how-to/subscriptions-and-alerts/create-new-alert) for the configuration settings you wish to track. If you choose to create an alert for a specific best practices report, you will receive this report each time SPDocKit detects either an error or a warning.
