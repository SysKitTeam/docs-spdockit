...
If you would like to explore your farm's SharePoint ULS and Windows event viewer logs, or track server health by monitoring performance counters, then [configure the SPDocKit Insights feature](options-wizard.md#internal/spdockit-insights/configure-data-collection). Learn more about [SPDocKit Insights](options-wizard.md#internal//spdockit-insights/insights-quick-start-guide) and how it can help you address all possible issues in your farm.
...
Please note that there is an option to “Mark Configuration as Good”. Marking a snapshot this way will exclude it from the data retention. For more information on this go [here](options-wizard.md#internal/get-to-know-spdockit/snapshots-screen/).
...
[Read more about scheduling subscriptions and alerts.](options-wizard.md#internal/get-to-know-spdockit/backstage-screen/subscriptions-and-alerts/)
...
1. Enable automatic subscriptions in the [Subscription Settings](options-wizard.md#internal/get-to-know-spdockit/backstage-screen/options-wizard#subscription-settings) tab.
2. [Create new alert](options-wizard.md#internal/how-to/subscriptions-and-alerts/create-new-alert/) containing the Farm Documentation, Farm Differences or Best Practices Documentation reports.
