...
* **File Name** – to activate this column go to the **View** tab and use the **Choose Columns** button. For more information on how to change the default file name [see here](https://github.com/SysKitTeam/docs-spdockit/tree/b3a68162cc031e20fb6d0e2432de8a1fe323748f/get-to-know-spdockit/backstage-screen/options-wizard/README.md#snapshot-options.md) and observe the snapshots name template section.
